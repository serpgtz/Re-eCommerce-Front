  ...
  return (
    <div className={styles.container}>
      ...
      >
        <Box sx={style}>
          {error_ === false ? (
            <Alert severity="success">Ya elijio el Local!</Alert>
          ) : (
            <Alert severity="info">
              Elije el local para retirar el Producto
            </Alert>
          )}
            ...
            >
              ...
              <FormGroup>
                <FormControlLabel
                  control={
                    <Checkbox
                      disabled={jason || (antoine && true)}
                      value="Rivadavia 18005, B1708 Morón, Provincia de Buenos Aires"
                      checked={gilad}
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      disabled={gilad || (antoine && true)}
                      value="Av. Dr. Honorio Pueyrredón 1841, Buenos Aires"
                      checked={jason}
                      onChe
                      onChange={handleChange}
                      name="jason"
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      disabled={gilad || (jason && true)}
                      value="Domingo Faustino Sarmiento 36, C6740 Chacabuco, Provincia de Buenos Aires"
                      checked={antoine}
                      onChange={handleChange}
                      name="antoine"
                    />
